...
# --- Configuration ---
GROUP_ID = -1003232934009     # numeric group ID (required)
GROUP_USERNAME = "@CodeFlix_Xx"     # for join button (@username only)

CHANNEL_ID = -1003232934009    # numeric channel ID (required)
